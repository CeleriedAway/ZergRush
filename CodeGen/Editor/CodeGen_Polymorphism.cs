...
namespace ZergRush.CodeGen
{
    public static partial class CodeGen
    {
        ...
        public static readonly string PolymorphClassIdGetter = UseClassIdCaching ? "ClassIdCached()" : "GetClassId()";
        ...
        public static bool CanBeAncestor(this Type t)
        {
            ...
            if (t.IsGenericType && t.BaseType != null) // IsGenericType == true also when it just implements generic interface.
            {
                return t.BaseType.CanBeAncestor();
            }

            return t.IsAbstract || (baseClassMap.ContainsKey(t) || polymorphicMap.ContainsKey(t)) && parents.Contains(t);
        }
