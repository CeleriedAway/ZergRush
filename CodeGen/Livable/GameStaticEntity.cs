...
{
    [GenTask((GenTaskFlags.ConfigData | GenTaskFlags.UIDGen) & ~GenTaskFlags.PolymorphicConstruction), GenOmniInternal, Immutable, GenTaskCustomImpl(GenTaskFlags.UIDGen)]
    ...
    [GenTask((GenTaskFlags.ConfigData | GenTaskFlags.UIDGen) & ~GenTaskFlags.PolymorphicConstruction), GenOmniInternal]
