...
namespace ZergRush
{
    public class ZRCompareCheckHelper
    {
        ...
        public bool NeedCompareCheck<T>(string name, Action<string> print, T self, T other)
        {
            ...
            {
                print(
                    $"{path.Reverse().ToCodeGenListString("/")} {name} in self object {self} was ecnountered first time " +
            ...
            {
                print(
                    $"{path.Reverse().ToCodeGenListString("/")} {name} in self object {self} was encountered not first time " +
            ...
            else 
            {
                ...
                {
                    print($"{path.Reverse().ToCodeGenListString("/")} {name} {self} {selfId} instance encountered second time " +
